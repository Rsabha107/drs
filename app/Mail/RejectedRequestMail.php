...
class RejectedRequestMail extends Mailable implements ShouldQueue
{
    ...
    {
        return $this->subject('VAPP Rejected ('.$this->vappRequest['event'].', ' . $this->vappRequest['request_ref_number'] .', '.$this->vappRequest['request_status'].')')
