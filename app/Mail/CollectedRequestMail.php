...
class CollectedRequestMail extends Mailable implements ShouldQueue
{
    ...
    {
        return $this->subject('VAPP Collected ('.$this->vappRequest['event'].', ' . $this->vappRequest['request_ref_number'] .', '.$this->vappRequest['request_status'].')')
                    ->view('emails.collected_request');
                    // ->attach(
                    //     $this->qrFilePath,
                    //     [
