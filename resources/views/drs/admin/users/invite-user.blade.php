            ...
            <div class="card-body p-0">
                <div class="p-4 code-to-copy">
                    <form class="row g-3  px-3 needs-validation" action="{{ route('drs.admin.users.invite.send') }}"
                        ...
                        <x-formy.form_select_row name="event_id" itemIdForeach="id" itemTitleForeach="name"
                            elementId="add_event_id" selectedValue="{{ old('event_id') }}"
                            classLabel="col-sm-3 col-form-label-sm" label="Event" :forLoopCollection="$events" class="row  mt-2"
                            style="margin:0 auto;" required="required" addDynamicButton="0"
                            dynamicModal="#add_event_id_modal" />
                        <x-formy.form_select_row name="venue_id" itemIdForeach="id" itemTitleForeach="title"
                            elementId="add_venue_id" selectedValue="{{ old('venue_id') }}"
                            classLabel="col-sm-3 col-form-label-sm" label="Venue" :forLoopCollection="$venues" class="row mt-2"
                            style="margin:0 auto;" required="required" addDynamicButton="0"
                            dynamicModal="#add_venue_id_modal" />
                        <x-formy.form_select_row name="functional_area_id" itemIdForeach="id" itemTitleForeach="title"
                            elementId="add_functional_area_id" selectedValue="{{ old('functional_area_id') }}"
                            classLabel="col-sm-3 col-form-label-sm" label="Functional Area" :forLoopCollection="$functional_areas"
                            class="row mb-3 mt-2" style="margin:0 auto;" required="required" addDynamicButton="0"
                            dynamicModal="#add_functional_area_id_modal" />
