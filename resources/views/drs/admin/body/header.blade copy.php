@php
    ...
    //     $event = App\Models\Drs\Event::findOrFail($current_event_id);
        ...
        <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="{{ route('home') }}">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('assets/img/icons/drs.jpg') }}" alt="{{ __('drs.page_title') }}"
                            width="27" />

                        {{-- @if ($session_set) --}}
                        <h3 class="logo-text ms-2 d-none d-sm-block">{{ __('drs.page_title') }} </h3>
                        ...
                        {{-- @else
                        <h6 class="logo-text ms-2 d-none d-sm-block">{{ __('drs.page_title') }}</h6>
                            @endif --}}
