...
<head>
    ...
    <link rel="stylesheet" href="https://unicons.iconscout.com/release/v4.0.8/css/line.css"
        integrity="2mD18YQDRE2gaMLgbA4j3ZoBRBOBtavcut3Cmbu/wEzjyRUaazYR4bXTTgsoz5gU">
    <link
        ...
        integrity="m25CKmrBg/89Z5DPIgXmRP0sj9UP6WuDkqTEfkx44HqkcLWxY/kTbi6FySKEgf5W" rel="stylesheet">
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-table@1.24.2/dist/bootstrap-table.min.css"
        integrity="1ie48E5ptWCDY9PXLXSMxA+rTXwrP63sKHXh8d9ong3ejEItSDkhid/S5enJvDeB" rel="stylesheet">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.8.3/font/bootstrap-icons.css"
        integrity="eoTu3+HydHRBIjnCVwsFyCpUDZHZSFKEJD0mc3ZqSBSb6YhZzRHeiomAUWCstIWo">
...
<body class="nav-slim">
    ...
    <main class="main" id="top">
        ...
        {{-- // start of content --}}
        @include('drs.customer.body.header')
        {{-- <x-vapp.customer.sidemenu_h /> --}}
        <div class="content">
            @yield('main')
            @include('drs.customer.partials.labels')
            @include('drs.customer.body.footer')
        </div>
        {{-- // end of content --}}
