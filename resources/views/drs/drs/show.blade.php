...
@section('main')
    ...
    <style>
        ...
        .drs-header-table td:first-child {
            font-weight: 600;
            width: 140px;
        }
...
@push('script')
    ...
    `;
        ...
        //                 title: 'Actions',
        //                 sortable: false,
        //                 formatter: itemActionsFormatter,
        //                 class: 'no-print'
        //             },
        //         ],
        //     });
        ...
        $('#delete_sheet_btn').on('click', function() {
            Swal.fire({
                ...
                $.ajax({
                    ...
                    error: function() {
                        toastr.error('Could not delete run sheet.');
                    }
                });
            });
        });
