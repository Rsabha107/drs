...
<div class="page-header">
            ...
            <form id="createReportForm" onsubmit="app.handleCreateReport(event)">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="half-width">
                            ...
                            <input class="input" type="date" name="date" value="${new Date().toISOString().split('T')[0]}">
                        </div>
                        <div class="half-width">
                            <label class="label">Time (24-hour format: HH:MM)</label>
                            <input class="input" type="text" name="time" placeholder="14:30" pattern="^([01]?[0-9]|2[0-3]):[0-5][0-9]$" value="${new Date().toTimeString().split(' ')[0].slice(0, 5)}" maxlength="5" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="half-width">
                            ...
                            <input class="input" type="text" name="expectedGatesTime" placeholder="12:30" pattern="^([01]?[0-9]|2[0-3]):[0-5][0-9]$" maxlength="5">
                        </div>
                        <div class="half-width">
                            <label class="label">Actual Gates Opening Time</label>
                            <input class="input" type="text" name="actualGatesTime" placeholder="12:35" pattern="^([01]?[0-9]|2[0-3]):[0-5][0-9]$" maxlength="5">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="half-width">
                            ...
                            <select class="input" name="tournament" id="tournamentSelect" onchange="app.handleTournamentChange()">
                            ...
                            <input class="input" name="tournamentCustom" id="tournamentCustom" placeholder="Enter custom tournament name" style="display: none; margin-top: 10px;">
                        </div>
                        <div class="half-width">
                    ...
                    <div class="input-group">
                        ...
                        <input class="input" type="number" name="attendance" placeholder="Official attendance" value="0" min="0">
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div style="font-size: 12px; color: #666; margin-bottom: 8px; font-style: italic;">💡 Tip: Use bullet points (•) or line breaks for better formatting. Your formatting will be preserved.</div>
                    <textarea class="textarea" name="actionsVUM" placeholder="Describe actions taken by VUM...\n\nExample with bullets:\n• Action item 1\n• Action item 2\n• Action item 3\n\nOr use numbered list:\n1. First action\n2. Second action\n3. Third action" style="white-space: pre-wrap; font-family: inherit;"></textarea>
                </div>
                    ...
                    <div class="sub-section">
                        ...
                        <div class="row">
                            ...
                            <div class="third-width">
                                ...
                                <input class="input" type="number" name="hospitalitySkyboxes" value="0" min="0">
                            </div>
                        </div>
                        <div class="row">
                            <div class="half-width">
                                <label class="label">Hospitality (lounges)</label>
                                <input class="input" type="number" name="hospitalityLounges" value="0" min="0">
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div style="font-size: 12px; color: #666; margin-bottom: 8px; font-style: italic;">💡 Tip: Use bullet points (•) or dashes (-) for better formatting. Your formatting will be preserved.</div>
                    <textarea class="textarea" name="transportSection" placeholder="Describe mobility arrangements...\n\nExample with bullets:\n• Bus route 1 - North entrance\n• Bus route 2 - South entrance\n• Metro station access\n\nOr use dashes:\n- Parking lot A: 500 spaces\n- Parking lot B: 300 spaces" style="white-space: pre-wrap; font-family: inherit;"></textarea>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div style="font-size: 12px; color: #666; margin-bottom: 8px; font-style: italic;">💡 Tip: Use bullet points (•) or dashes (-) for better formatting. Your formatting will be preserved.</div>
                    <textarea class="textarea" name="generalIssues" placeholder="Describe general comments...\n\nExample with bullets:\n• Everything went smoothly\n• Minor delay at gate 3\n• Excellent crowd management\n\nOr use dashes:\n- Weather was perfect\n- No major incidents\n- Staff performed well" style="white-space: pre-wrap; font-family: inherit;"></textarea>
                </div>
                    ...
                    <div class="voc-upload-options">
                        <div class="upload-option">
                            ...
                            <div class="file-upload-container">
                                ...
                                <button type="button" class="excel-upload-btn" onclick="document.getElementById('excelFileInput').click()">
                                    📁 Upload Excel File
                                </button>
                                <div id="excelFileName" class="file-name"></div>
                                <button type="button" id="removeExcelBtn" class="excel-remove-btn" onclick="app.removeExcelFile()" style="display: none; margin-left: 10px; padding: 5px 10px; background: #ff4444; color: white; border: none; border-radius: 4px; cursor: pointer;">Remove File</button>
                        ...
                        <div class="upload-option">
                            ...
                            <div class="voc-instructions">
                                <p>Copy and paste Excel table data below. Each row should be on a new line, with columns separated by tabs or spaces.</p>
...
002         Cleaning     Spilled drink in section A Closed    Cleaning Staff</pre>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-top: 20px;">
                    <button type="button" class="save-draft-button" onclick="app.saveDraftManually()" style="padding: 15px; background: #6c757d; color: white; border: none; border-radius: 8px; cursor: pointer; font-size: 16px; font-weight: bold; display: flex; align-items: center; justify-content: center; gap: 8px;">
            ...
            <div id="autoSaveIndicator" style="position: fixed; bottom: 70px; right: 20px; background: #4CAF50; color: white; padding: 8px 16px; border-radius: 20px; font-size: 12px; display: none; z-index: 1000;">
                ✓ Draft saved successfully
            </div>
            
            <!-- Page state indicator -->
            <div id="pageStateIndicator" style="position: fixed; bottom: 20px; right: 20px; background: #2196F3; color: white; padding: 6px 12px; border-radius: 15px; font-size: 11px; display: none; z-index: 1000;">
                📍 Position saved
            </div>
...
(function () {
    ...
    const tournamentCustom = document.getElementById('tournamentCustom');

    function syncTournamentCustom() {
        const isOther = tournamentSelect.value === 'Other';
        tournamentCustom.style.display = isOther ? 'block' : 'none';
        if (!isOther) tournamentCustom.value = '';
    }
    tournamentSelect.addEventListener('change', syncTournamentCustom);
    syncTournamentCustom();

    // Ctrl+S submit
    document.addEventListener('keydown', function (e) {
        if ((e.ctrlKey || e.metaKey) && e.key.toLowerCase() === 's') {
            e.preventDefault();
            document.getElementById('createReportForm').requestSubmit();
        }
    });

    // Optional draft save (AJAX)
    const saveDraftBtn = document.getElementById('saveDraftBtn');
    saveDraftBtn.addEventListener('click', async () => {
        const form = document.getElementById('createReportForm');
        const fd = new FormData(form);

        const res = await fetch(@json(route('reports.draft')), {
            method: 'POST',
