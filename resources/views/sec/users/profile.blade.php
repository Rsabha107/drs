...
@section('main')
    ...
    <div class="container">
        ...
        <section class="bg-light py-3 py-md-5 py-xl-8">
            ...
            @php
                $profile_src = route('global.file.serve', $file->id);
            @endphp
            <div class="container">
                                ...
                                <div class="card widget-card border-light shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center mb-3">
                                            <div class="avatar avatar-4xl avatar-bordered">
                                                <img class="img-fluid rounded-circle " src="{{ $profile_src }}"
                                                    alt="" />
                                            </div>
                                            {{-- <img src="{{ $profile_src }}" class="img-fluid rounded-circle" alt="Luna John"> --}}
                                        </div>
                                                ...
                                                <div class="row gy-2">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-3 text-start">
                                                            <input type="file" name="file_name" class="dropify" data-default-file="{{ $profile_src }}"
                                                                data-height="200" />
                                                        </div>
                                                        <div class="avatar avatar-5xl ">
                                                            <img class="rounded-none " src="{{ $profile_src }}"
                                                                alt="">

                                                        </div>

                                                        {{-- <img src="{{ $profile_src }}" class="img-fluid" alt="Luna John"> --}}
                                                    </div>
                                                    <div class="col-12">
                                                        <a href="#!"
