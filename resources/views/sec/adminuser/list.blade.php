                                    ...
                                    <table class="table table-sm table-responsive fs--1 mb-0 overflow-hidden" id="dataList">
                                        <thead class="text-900 thead">
                                            <tr>
                                                ...
                                                <th class="sort ps-3 pe-1 align-middle white-space-nowrap" data-sort="orderId" style="min-width: 4.5rem;">Venue</th>
                                        ...
                                        <tbody class="list">
                                            ...
                                            <tr>
                                                ...
                                                <td class="ps-3">
                                                    ...
                                                    <span class='badge badge-pill bg-body-tertiary'>{{ $venue_item->title }}</span>
                                                    @endforeach
                                                </td>
